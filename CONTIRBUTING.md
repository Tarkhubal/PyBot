...
L'objectif est de permettre des ajouts communautires **sans compromettre la stabilité du bot**
...
2) `register(tree,config)`
    ...
    Les opération d'I/O sont **autorisées uniquement** dans les handlers des commandes

### Commandes et conflits
- Les noms de slash commands doivent être uniques.
- Le loader refusera toute feature créant in conflit de nom
- Il est recommandéd'utiliser un **groupe de commande par feature** 
...
Les Pull Request doivent cibler la branche `main`
...
- Le staff se réserve le droit de refuser une PR:
    - trop complexe
    - mal isolée
    - dificile à maintenir
    - non alignée avec la philosophie du projet

### En cas de doute
- Regardez les feature existantes (`ping`, `say`)
